...
// log events to a zap.Logger. defaultLevel set the logs
// without "github.com/go-kit/log/level" keyvals to defaultLevel
func NewZapSugarLogger(logger *zap.Logger, defaultLevel zapcore.Level) log.Logger {
